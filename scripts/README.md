...
region in the root README: article and view totals, the three newest columns by
creation date, and the three newest articles by publication date. Empty new
columns are labeled “新建专栏”; followers are not displayed. The curated Vue series
and source link remain outside the generated region.
