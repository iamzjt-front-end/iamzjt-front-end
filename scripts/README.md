...
and likes inline after its title as plain text labels; publication dates are used for sorting only.
...
as “文章累计阅读”; this is not column-page traffic or unique visitors. Incomplete
